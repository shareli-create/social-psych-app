...
const LECTURE_TOPICS = [
  {
    ...
    concepts: "Pluralistic ignorance, bystander effect, diffusion of responsibility, scientific method in psychology, the person as a social creature."
  },
  {
    id: 2,
    week: 2,
    title: "Social Perception & First Impressions",
    concepts: "First impressions, physical attractiveness, spontaneous trait inferences, non-verbal cues (deception cues), attribution theory."
  },
  {
    id: 3,
    week: 3,
    title: "Emotion & Social Cognition",
    concepts: "Role of emotion in social interaction, causal attribution for events and emotions, cognitive heuristics (availability, representativeness, anchoring), perception of social power."
  },
  {
    id: 4,
    week: 4,
    title: "Attitudes and Persuasion",
    concepts: "Cognitive, affective, and behavioral components of attitudes, persuasion, Elaboration Likelihood Model (Central vs. Peripheral routes), inoculation strategy."
  },
  {
    id: 5,
    week: 5,
    title: "The Social Self",
    concepts: "Self-concept, self-esteem (trait vs. state), self-schemas, introspection, affective forecasting, social comparison, spotlight effect, cultural differences in self-concept."
  },
  {
    id: 6,
    week: 6,
    title: "Stereotypes, Prejudice & Intergroup Relations",
    concepts: "In-groups vs. out-groups, stereotypes, prejudice, discrimination, Social Identity Theory, out-group homogeneity effect, stereotype threat, minimal group paradigm."
  },
  {
    id: 7,
    week: 7,
    weekLabel: "7 & 8",
    title: "Group Influence & Processes",
    concepts: "Conformity (normative and informational influence), Asch's experiment, obedience, group polarization, groupthink, social facilitation, social loafing, deindividuation."
  },
];

// --- Start of Icons ---
const SpinnerIcon = ({ className }) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: `animate-spin ${className}` },
    React.createElement('path', { d: "M21 12a9 9 0 1 1-6.219-8.56" })
  )
);
const ErrorIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className: className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        React.createElement('path', { d: "M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" }),
        React.createElement('path', { d: "M12 9v4" }),
        React.createElement('path', { d: "M12 16v.01" })
    )
);
const PointerIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        React.createElement('path', { d: "M8 13v-8.5a1.5 1.5 0 0 1 3 0v7.5" }),
        React.createElement('path', { d: "M11 11.5v-2a1.5 1.5 0 0 1 3 0v2.5" }),
        React.createElement('path', { d: "M14 10.5a1.5 1.5 0 0 1 3 0v1.5" }),
        React.createElement('path', { d: "M17 11.5a1.5 1.5 0 0 1 3 0v4.5a6 6 0 0 1 -6 6h-2h.208a6 6 0 0 1 -5.012 -2.7l-.196 -.3c-.312 -.479 -1.407 -2.388 -3.286 -5.728a1.5 1.5 0 0 1 .536 -2.022a1.867 1.867 0 0 1 2.28 .28l1.47 1.47" })
    )
);
const RefreshIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        React.createElement('path', { d: "M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4" }),
        React.createElement('path', { d: "M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4" })
    )
);
const NewspaperIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        React.createElement('path', { d: "M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a1 1 0 0 1 1 -1h3" }),
        React.createElement('path', { d: "M16 3l-4 4l-4 -4" }),
        React.createElement('line', { x1: "12", y1: "12", x2: "12", y2: "16" }),
        React.createElement('line', { x1: "16", y1: "12", x2: "16", y2: "16" }),
        React.createElement('line', { x1: "8", y1: "12", x2: "8", y2: "16" })
    )
);
const LightbulbIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
        React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        React.createElement('path', { d: "M9 16a5 5 0 1 1 6 0a3.5 3.5 0 0 0 -1 3a2 2 0 0 1 -4 0a3.5 3.5 0 0 0 -1 -3" }),
        React.createElement('path', { d: "M9.7 17l4.6 0" })
    )
);
const ExternalLinkIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className: className, width: "24", height: "24", viewBox: "0 0 24 24", strokeWidth: "2", stroke: "currentColor", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" },
       React.createElement('path', { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
       React.createElement('path', { d: "M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6" }),
       React.createElement('path', { d: "M11 13l9 -9" }),
       React.createElement('path', { d: "M15 4h5v5" })
    )
);
const SparklesIcon = ({ className }) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, viewBox: "0 0 24 24", fill: "currentColor" },
        React.createElement('path', { d: "M12,2A3,3,0,0,0,9,5A3,3,0,0,0,12,8A3,3,0,0,0,15,5A3,3,0,0,0,12,2M5,9A3,3,0,0,0,2,12A3,3,0,0,0,5,15A3,3,0,0,0,8,12A3,3,0,0,0,5,9M19,9A3,3,0,0,0,16,12A3,3,0,0,0,19,15A3,3,0,0,0,22,12A3,3,0,0,0,19,9M12,16A3,3,0,0,0,9,19A3,3,0,0,0,12,22A3,3,0,0,0,15,19A3,3,0,0,0,12,16Z" })
    )
);
const ApprenticeAvatarIcon = ({ className }) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className, viewBox: "0 0 24 24", fill: "currentColor" },
    ...
    React.createElement('path', { d: "M12 5c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3-1.346-3-3-3zm0 4c-.551 0-1-.449-1-1s.449-1 1-1 1 .449 1 1-.449 1-1 1z" }),
    React.createElement('path', { d: "M12 13c-2.481 0-4.5 2.019-4.5 4.5V18h9v-.5c0-2.481-2.019-4.5-4.5-4.5zm0 3c.827 0 1.5.673 1.5 1.5V18h-3v-.5c0-.827.673-1.5 1.5-1.5z" }),
